...
<body>
    ...
    <header class="container-fluid text-center d-flex flex-column align-items-center justify-content-center py-5 mb-5 mt-5">
        ...
        <div class="d-flex justify-content-center mx-auto mt-5 box-input" >
            <input type="text" placeholder="temukan barangmu" class="search rounded-start" id="search"  onkeypress="clickPress(event)">
            <button class="button px-3 border-none background-yellow rounded-end ms-1 text-light fs-7" id="btnSearch"><i class="bi bi-search"></i></button>
        </div>
        <div class="img-size">
    ...
    <div class="container-fluid background-blue">
        <div class="container background-blue2 rounded daftar-barang pb-3" >
            ...
            <div class="box-item">
                <div class="card">
                    <div class="card-header text-center fw-bold">kunci</div>
                    <img src="https://th.bing.com/th/id/OIP.dpJo0hT62hwFmL_zadWFXAHaFY?rs=1&pid=ImgDetMain" class="card-img-top px-3 pt-3">
                    <div class="card-body d-flex">
                        <a href="#" class="button text-light p-2 w-100 background-yellow fw-bold fs-6 rounded mt-auto">DETAIL</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header text-center fw-bold">kunci</div>
                    <img src="https://th.bing.com/th/id/OIP.CAB3vZLbvg2LPxt0pYFGAQHaHa?rs=1&pid=ImgDetMain" class="card-img-top px-3 pt-3">
                    <div class="card-body d-flex">
                        <a href="#" class="button text-light p-2 w-100 background-yellow fw-bold fs-6 rounded mt-auto">DETAIL</a>
                    </div>
                </div>
...
const iconSearch = document.querySelector('button i.bi');
